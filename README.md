...
| `complete_unheld_job` | Archives a `READY` job that never acquired (or no longer holds) a lease, unblocking dependent work.                  | `complete_unheld_job(job_id TEXT, worker_id TEXT)`                                                                                          |
